...
TIER_OF = {
    ...
    "whc_tree":          "statistics",
    "whc_tree_fisher":   "statistics",
    "whc_tree_grad":     "statistics",
    "whc_tree_full":     "statistics",
    "whc_tree_iter":     "statistics",
}
LABEL_OF = {
    "simple":            "Simple Avg.",
    ...
    "whc_tree":          "WHC (tree)",
    "whc_tree_fisher":   "WHC + γ-Fisher",
    "whc_tree_grad":     "WHC + β-grad",
    "whc_tree_full":     "WHC (full Eq. 29)",
    "whc_tree_iter":     "WHC (iter)",
}
COLOR_OF = {
    "simple":            "#ADB5BD",
    ...
    "regmean_plus":      "#92400E",
    "whc_tree":          AC_BLUE,
    "whc_tree_fisher":   AC_TEAL,
    "whc_tree_grad":     AC_RED,
    "whc_tree_full":     AC_ROSE,
    "whc_tree_iter":     "#1E3A8A",
}
