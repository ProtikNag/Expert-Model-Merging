...
| Model | Instruction | Math | humaneval+ | mbpp+ | Safety | Multilingual | Avg |
|---|---|---|---|---|---|---|---|
| Llama-3.1-8B (no merge) | 8.9 | 56.3 | | | | 54.0 | 39.7 |
...
- Bold = column max. Safety column pending (4th eval env not yet built).
